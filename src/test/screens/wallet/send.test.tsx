...
describe('Send screen', () => {
  const renderSendForm = ({
    ...
    walletContext = { ...mockWalletContextValue, walletReady: true },
  } = {}) =>
    render(
  ...
  it('renders the loading send screen correctly', async () => {
    renderSendForm({ walletContext: { ...mockWalletContextValue, walletReady: false } })
  ...
  it('fills the amount field when an LNURL resolves to a fixed amount', async () => {
    ...
    const walletValue = {
      ...
      balance: 1_000_000,
      walletReady: true,
      getAvailableBalance: async () => 1_000_000,
    }
  ...
  it('shows BTC units on the send amount field when currency and bitcoin unit are BTC', async () => {
    const walletValue = {
      ...mockWalletContextValue,
      walletReady: true,
      getAvailableBalance: async () => 12128,
    }
    const configValue = {
      ...mockConfigContextValue,
      useFiat: false,
