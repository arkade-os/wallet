...
export default function App() {
  ...
  useEffect(() => {
    console.log('Chatwoot token present?', import.meta.env.VITE_CHATWOOT_WEBSITE_TOKEN)
    console.log('Chatwoot base url present?', import.meta.env.VITE_CHATWOOT_BASE_URL)
