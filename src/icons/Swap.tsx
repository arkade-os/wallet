...
export function SwapSuccessIcon() {
  return (
    <svg width='42' height='43' viewBox='0 0 42 43' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <rect y='0.5' width='40' height='40' rx='20' fill='#FBFBFB' fillOpacity='0.1' />
      <path
      ...
      />
      <path d='M25.5809 16.75H13.75' stroke='white' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M14.4531 24.25H26.25' stroke='white' strokeWidth='1.5' strokeLinecap='round' strokeLinejoin='round' />
