...
ARG VITE_LNURL_SERVER=__VITE_LNURL_SERVER__
ARG VITE_LNURL_DOMAIN=__VITE_LNURL_DOMAIN__
...
ENV VITE_ARK_SERVER=$VITE_ARK_SERVER \
    ...
    VITE_LNURL_SERVER=$VITE_LNURL_SERVER \
    VITE_LNURL_DOMAIN=$VITE_LNURL_DOMAIN \
